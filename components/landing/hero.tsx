      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center gap-3 bg-card px-8 py-4 rounded-2xl shadow-lg border border-border">
              <GraduationCap className="w-12 h-12 text-accent" />
              <h1 className="text-5xl py-1 font-bold bg-linear-to-r from-primary to-accent bg-clip-text text-transparent">
                {t("h1")}
              </h1>
            </div>
          </div>
